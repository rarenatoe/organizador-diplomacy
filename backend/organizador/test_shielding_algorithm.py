...
class TestShieldingAlgorithm(unittest.TestCase):
    ...
    def test_algorithm_runs_without_errors(self):
        ...
        players = [
            DraftPlayer(name="Alice", experience="Antiguo", games_this_year=5, priority="False", desired_games=1, gm_games=0,
                         c_england=1, c_france=1, c_germany=1, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),
            DraftPlayer(name="Bob", experience="Antiguo", games_this_year=3, priority="False", desired_games=1, gm_games=0,
                         c_england=0, c_france=0, c_germany=0, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),
            DraftPlayer(name="Charlie", experience="Antiguo", games_this_year=2, priority="False", desired_games=1, gm_games=0,
                         c_england=0, c_france=0, c_germany=0, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),
        ]
    ...
    def test_cursed_players_get_shields_assigned(self):
        ...
        players = [
            ...
            DraftPlayer(name="Bob", experience="Antiguo", games_this_year=1, priority="False", desired_games=1, gm_games=0,
                         c_england=0, c_france=0, c_germany=0, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),  # Clean history
            DraftPlayer(name="Charlie", experience="Antiguo", games_this_year=1, priority="False", desired_games=1, gm_games=0,
                         c_england=0, c_france=0, c_germany=0, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),  # Clean history
        ]
    ...
    def test_no_cursed_players_remain_unassigned(self):
        ...
        for player in players:
            self.assertEqual(player.country, "", f"Player {player.name} should have no country assigned")
    ...
    def test_optimal_shield_selection_and_reason(self):
        ...
        players = [
            ...
            DraftPlayer(name="Alice", experience="Antiguo", games_this_year=5, priority="False", desired_games=1, gm_games=0, c_england=2, c_france=0, c_germany=0, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),
            # Bob has played England once (1 game).
            DraftPlayer(name="Bob", experience="Antiguo", games_this_year=3, priority="False", desired_games=1, gm_games=0, c_england=1, c_france=0, c_germany=0, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),
            # Charlie has never played England (0 games).
            DraftPlayer(name="Charlie", experience="Antiguo", games_this_year=2, priority="False", desired_games=1, gm_games=0, c_england=0, c_france=0, c_germany=0, c_italy=0, c_austria=0, c_russia=0, c_turkey=0),
        ]
        ...
        self.assertEqual(players[2].country, "England", "Charlie should be picked as a shield for England")
