...
- test_viewer_snapshot.py: /api/snapshot, /api/snapshots, DELETE /api/snapshot
- test_viewer_run.py: /api/run
- test_viewer_sync.py: /api/sync/detect, /api/sync/confirm
...
from .test_viewer_snapshot import TestApiSnapshot, TestApiSnapshots, TestApiDeleteSnapshot, TestApiEditSnapshot
from .test_viewer_run import TestApiRun
from .test_viewer_sync import TestApiSyncDetect, TestApiSyncConfirm
